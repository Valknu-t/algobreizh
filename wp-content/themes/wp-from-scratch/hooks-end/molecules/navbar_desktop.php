...
<div class="flex flex-row w-full bg-darkgreenab opa-75 text-2xl justify-between px-10 h-16 items-center shadow-lg">
        ...
        <div class="flex flex-row justify-between w-1/3 text-white pl-40 mt-6">
            ...
            <div>
                ...
                <a class="flex text-white hover:text-lightgreen" href="<?php echo get_home_url(); ?>">Accueil</a>
            ...
            ?>
                ...
                <div>
                    <a class="flex text-white hover:text-lightgreen" href="/boutique">Boutique</a>
                </div>

                <div>
                    <a class="flex text-white hover:text-lightgreen" href="/historique">Historique</a>
                </div>
            ...
            ?>
                ...
                <div>
                    ...
                    <a class="flex text-white hover:text-lightgreen" href="/admin">Admin</a>
            ...
            <div>
                ...
                <a class="flex text-white hover:text-lightgreen" href="/contact">Contact</a>
